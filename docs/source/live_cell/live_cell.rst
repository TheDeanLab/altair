...
25-37 C, with 90% of applications being done at 37 C. We've traditionally done this temperature regulation in the past
using a combined system comprised of thermocouples (for detecting ambient temperature), heating pads (to heat the
...
drifting that affect imaging performance.
...
possible, we sourced all of the heating elements for this system directly from McMaster-Carr. There are certainly
...
temperature controller. Below in Figure 2 we show the general process of attaching one of these adapters to the two
thermocouple wires:
...
unpolarized. Below in Figure 3 we show the general process of attaching one of these adapters to the two heater unit
wires:
...
.. figure:: Images/Colored_Invert_Scalebar.gif
    ...
    **Figure 7:** Live-cell imaging timelapse of migrating RPE cells.

.. figure:: Images/LiveCellStills.png
    :align: center
    :alt: Assembly and Setting of the temperature controllers

    **Figure 8:** Stills from our live-cell video showing actively migrating retinal pigment epithelial (RPE) cells,
    showing vimentin (blue) and microtubules (orange). The series comprises 50 frames; representative time points are
    displayed.
