...
- 	`TGCOM <https://asiimaging.com/docs/tg1000_info#description>`_ - allows Joystick control and serial communication from computer

-	3 Stage control cards - (X/Y, Z/F, M/N)

-	2 `DAC4 <https://asiimaging.com/docs/tggalvo>`_ cards - Analog signal generators

-	`TGPLC <https://asiimaging.com/docs/tiger_programmable_logic_card>`_ - Programmable Logic Controller which provides for custom timing
